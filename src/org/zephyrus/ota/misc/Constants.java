...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.zeph.date.utc";
    ...
    static final String CHANGELOG_URL = "https://raw.githubusercontent.com/Project-Zephyrus-CAF/OTA/%s/%s/changelog_%s.txt";
