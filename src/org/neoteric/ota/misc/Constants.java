...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.neoteric.date.utc";
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/ShadeDark6/neoteric_OTA/%s/%s/ota.json";
    static final String CHANGELOG_URL = "https://raw.githubusercontent.com/ShadeDark6/neoteric_OTA/%s/%s/changelog_%s.txt";
    static final String CHANGELOG_URL_LOCALE = "https://raw.githubusercontent.com/ShadeDark6/neoteric_OTA/%s/%s/changelog_%s-%s-r%s.txt";
